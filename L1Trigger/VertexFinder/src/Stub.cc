...
namespace l1tVertexFinder {
  ...
  Stub::Stub() : settings_(nullptr), phi_(0.), r_(0.), z_(0.), idDet_(0),
                 moduleMinR_(0.), moduleMaxR_(0.), moduleMinPhi_(0.), moduleMaxPhi_(0.), moduleMinZ_(0.), moduleMaxZ_(0.),
                 psModule_(false), layerId_(0), endcapRing_(0), barrel_(false),
                 sigmaPerp_(0.), sigmaPar_(0.), stripPitch_(0.), stripLength_(0.),
                 nStrips_(0), sensorWidth_(0.), outerModuleAtSmallerR_(false) {}
