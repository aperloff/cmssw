...
namespace l1tVertexFinder {
  ...
  VertexNTupler::VertexNTupler(const edm::ParameterSet& iConfig)
      : inputDataToken_(consumes<l1tVertexFinder::InputData>(iConfig.getParameter<edm::InputTag>("inputDataInputTag"))),
        ...
        allMatchedTPsToken_(consumes<std::vector<l1tVertexFinder::TP>>(iConfig.getParameter<edm::InputTag>("l1TracksTPInputTags"))),
        vTPsToken_(consumes<edm::ValueMap<l1tVertexFinder::TP>>(iConfig.getParameter<edm::InputTag>("l1TracksTPValueMapInputTags"))),
