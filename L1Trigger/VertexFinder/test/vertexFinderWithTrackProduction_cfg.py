...
options.register('threads',1,VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.int,"Number of threads to use")
options.register('streams',0,VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.int,"Number of streams to use")
options.register('keepAll',False,VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.bool,"Keep all of the pranches (input and output)")
...
if options.analysis and options.threads>1:
    raise RuntimeError("Can't run in multithreaded mode when using the TFileService. Run in producer mode to use multiple threads.")
...
if options.analysis:
    ...
    if options.keepAll:
        ...
        OC = cms.untracked.vstring(
            ...
            "keep TrackingVertexs_mix_*_*",
            "keep *_*_*_L1TVertexFinder",
            "keep *_VertexProducer_*_*"
        )
...
#--- Load config fragment that configures the TTTracks
